...
const ImageRotator = ({ images }) => {
	...
	useEffect(() => {
		...
		anime({
			...
			translateX: { value: isSmallScreen ? 0 : [-120, 0], delay: 3000 },
			translateY: {
				value: isSmallScreen ? [-70, 0] : [70, 0],
				delay: isSmallScreen ? 3000 : 4200,
			},
			delay: 4000,
			duration: 1000,
		...
		anime({
			...
			translateX: isSmallScreen ? 0 : [-150, 0],
			translateY: isSmallScreen ? [-150, 0] : 0,
			delay: 3000,
			duration: 1000,
			easing: "easeInOutExpo",
		});
	...
	return (
		<div className="imageRotator">
			<img
				...
				id={"album-cover"}
			/>
			<div className="imageRotatorDetails">
				<div
					style={{
